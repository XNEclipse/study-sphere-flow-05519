    ...
    nodes: [
      {
        ...
        type: 'custom',
        position: { x: 250, y: 50 },
        data: { label: 'Chapter Topic', shape: 'rounded', color: 'hsl(270, 60%, 85%)' },
      },
      {
        id: '2',
        type: 'custom',
        position: { x: 100, y: 200 },
        data: { label: 'Key Concept 1', shape: 'rounded', color: 'hsl(160, 50%, 80%)' },
      },
      {
        id: '3',
        type: 'custom',
        position: { x: 400, y: 200 },
        data: { label: 'Key Concept 2', shape: 'rounded', color: 'hsl(160, 50%, 80%)' },
      },
    ],
    edges: [
    ...
    nodes: [
      {
        ...
        type: 'custom',
        position: { x: 250, y: 50 },
        data: { label: 'Essay Topic', shape: 'rounded', color: 'hsl(270, 60%, 85%)' },
      },
      {
        id: '2',
        type: 'custom',
        position: { x: 250, y: 150 },
        data: { label: 'Introduction', shape: 'rounded', color: 'hsl(200, 60%, 85%)' },
      },
      {
        id: '3',
        type: 'custom',
        position: { x: 100, y: 250 },
        data: { label: 'Point 1', shape: 'rounded', color: 'hsl(160, 50%, 80%)' },
      },
      {
        id: '4',
        type: 'custom',
        position: { x: 250, y: 250 },
        data: { label: 'Point 2', shape: 'rounded', color: 'hsl(160, 50%, 80%)' },
      },
      {
        id: '5',
        type: 'custom',
        position: { x: 400, y: 250 },
        data: { label: 'Point 3', shape: 'rounded', color: 'hsl(160, 50%, 80%)' },
      },
      {
        id: '6',
        type: 'custom',
        position: { x: 250, y: 350 },
        data: { label: 'Conclusion', shape: 'rounded', color: 'hsl(200, 60%, 85%)' },
      },
    ],
    edges: [
      { id: 'e1-2', source: '1', target: '2', type: 'smoothstep', animated: true, markerEnd: { type: MarkerType.ArrowClosed } },
    ...
    nodes: [
      {
        ...
        data: { label: 'Phase 1: Research', shape: 'rounded', color: 'hsl(270, 60%, 85%)' },
      },
      {
        id: '2',
        type: 'custom',
        position: { x: 300, y: 100 },
        data: { label: 'Phase 2: Planning', shape: 'rounded', color: 'hsl(200, 60%, 85%)' },
      },
      {
        id: '3',
        type: 'custom',
        position: { x: 500, y: 100 },
        data: { label: 'Phase 3: Execution', shape: 'rounded', color: 'hsl(160, 50%, 80%)' },
      },
    ],
    edges: [
      { id: 'e1-2', source: '1', target: '2', type: 'smoothstep', animated: true, markerEnd: { type: MarkerType.ArrowClosed } },
    ...
    nodes: [
      {
        ...
        type: 'custom',
        position: { x: 250, y: 150 },
        data: { label: 'Central Idea', shape: 'circle', color: 'hsl(20, 80%, 85%)' },
      },
      {
        id: '2',
        type: 'custom',
        position: { x: 100, y: 50 },
        data: { label: 'Idea 1', shape: 'rounded', color: 'hsl(55, 70%, 85%)' },
      },
      {
        id: '3',
        type: 'custom',
        position: { x: 400, y: 50 },
        data: { label: 'Idea 2', shape: 'rounded', color: 'hsl(55, 70%, 85%)' },
      },
      {
        id: '4',
        type: 'custom',
        position: { x: 100, y: 250 },
        data: { label: 'Idea 3', shape: 'rounded', color: 'hsl(55, 70%, 85%)' },
      },
      {
        id: '5',
        type: 'custom',
        position: { x: 400, y: 250 },
        data: { label: 'Idea 4', shape: 'rounded', color: 'hsl(55, 70%, 85%)' },
      },
    ],
    edges: [
      { id: 'e1-2', source: '1', target: '2', type: 'smoothstep', animated: true, markerEnd: { type: MarkerType.ArrowClosed } },
